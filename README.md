...
<a name="table">Table 1 - Minimum Junos OS Release supporting routing-instance awareness for management services</a>
...
**REMARK** - although often called "management VRF", the routing instance **mgmt_junos** is actually not a VRF. Junos OS hardcoded its **instance-type** to be **forwarding** and this cannot be changed.
